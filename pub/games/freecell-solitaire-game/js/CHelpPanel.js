function CHelpPanel(){
    ...
    this._init = function(){
        ...
        _oText3Back = new createjs.Text(TEXT_HELP3," 24px Arial", "#000000");
        _oText3Back.x = oText3Pos.x +2;
        _oText3Back.y = oText3Pos.y +2;
        _oText3Back.textAlign = "center";
        _oText3Back.lineWidth = 230;
  
        _oText3 = new createjs.Text(TEXT_HELP3," 24px Arial", "#ffffff");
        ...
        _oText1BackPage2 = new createjs.Text(TEXT_HELP1_PAGE2," 30px Arial", "#000000");
        ...
        _oText1Page2 = new createjs.Text(TEXT_HELP1_PAGE2," 30px Arial", "#ffffff");
        _oText1Page2.x = CANVAS_WIDTH/2;
        _oText1Page2.y = (CANVAS_HEIGHT/2)-202;
        _oText1Page2.textAlign = "center";
        _oText1Page2.lineWidth = 400;              
        
        _oText2BackPage2 = new createjs.Text(TEXT_HELP2_PAGE2 + START_SCORE + TEXT_HELP3_PAGE2," 30px Arial", "#000000");
        ...
        _oText2Page2 = new createjs.Text(TEXT_HELP2_PAGE2 + START_SCORE +TEXT_HELP3_PAGE2," 30px Arial", "#ffffff");
        _oText2Page2.x = CANVAS_WIDTH/2;
        _oText2Page2.y = (CANVAS_HEIGHT/2)-102;
        _oText2Page2.textAlign = "center";
        _oText2Page2.lineWidth = 400;       
        
        _oTextLosePage2Back = new createjs.Text(TEXT_LOSE1_PAGE2 + POINTS_TO_LOSE + TEXT_LOSE2_PAGE2," 28px Arial", "#000000");
        ...
        _oTextLosePage2 = new createjs.Text(TEXT_LOSE1_PAGE2 + POINTS_TO_LOSE + TEXT_LOSE2_PAGE2," 28px Arial", "#ffffff");
