function CInterface(iCurBet,iTotBet,iMoney){
	...
	_oMoneyText = new createjs.Text(TEXT_MONEY +"\n"+iMoney.toFixed(2),"30px walibi0615bold", "#f951aa");
        _oMoneyText.x = 140;
        _oMoneyText.y = 78;
        ...
        _oCoinText = new createjs.Text(iCurBet.toFixed(2) ,"30px walibi0615bold", "#ffffff");
        _oCoinText.x =  476;
        ...
        _oTotalBetText = new createjs.Text(TEXT_BET +": "+iTotBet.toFixed(2),"30px walibi0615bold", "#ffffff");
